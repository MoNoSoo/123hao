...
<table class="table table-bordered">
    ...
    foreach ($result as $row) {
        ...
        <tr>
            ...
            <td><a href="index.php/config/workflow/wfconfig/detail?wfuid=<?= $row['wf_uid'] ?>" target="_blank">查看</a>
                <a href="index.php/config/workflow/wfconfig/edit?wfuid=<?= $row['wf_uid'] ?>" target="_blank">编辑</a>
                <a href="index.php/config/workflow/wfedit/tree?wfuid=<?= $row['wf_uid'] ?>" target="_blank">树图</a>
                <a href="index.php/config/workflow/wfedit/flow?wfuid=<?= $row['wf_uid'] ?>" target="_blank">流程图</a>
                <a href="index.php/config/workflow/list_variate/loadView?wf_uid=<?= $row['wf_uid'] ?>" target="_blank">变量</a>
                <a href="index.php/config/workflow/list_role/loadView?wf_uid=<?= $row['wf_uid'] ?>"
                   target="_blank">角色</a>
                <a href="javascript:void(0)" onclick="history_list('<?= $row['wf_uid'] ?>')" target="_blank">历史版本</a>
            </td>
        </tr>
