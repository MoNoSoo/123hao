            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-sm-4 col-sm-offset-8 col-xs-6 col-xs-offset-6 col-md-6 col-md-offset-6">
                    ...
                    <button type="button" class="btn btn-primary btn-sm"
                            onclick="window.location.href='<?php echo site_url("purchase/purchase/open") ?>'">新建
                    </button>
                </div>
            </div>
    </form>
            ...
            'columns': [
                ...
                {sName: 'contract_sum', data: 'contract_sum', className: 'dt_nowrap'},
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var operate = "<a onclick=flowPreview('" + et_uid + "') >流程预览</a> | <a onmouseover=get_approver(this,'" + et_uid + "') >审批节点</a>";
                        return operate;
                    }
                },
                {
