...
//        $sql2 = "SELECT * FROM t_wf_workflow where 1= 1";
        $result = $this->db->query($sql);
//
//        $result = $this->db->query($sql2);
////        $query = $this->db->get("t_wf_workflow");
////        $query->result_array();
//        var_dump(mb_detect_encoding($result->result_array()[0]['wf_name']));
//        die;
//        var_dump($result->result_array(), 1112);
//        die;
